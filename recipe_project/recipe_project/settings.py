"""
Django settings for recipe_project - PRODUCTION ENVIRONMENT

IMPORTANT: This file is for PRODUCTION deployment only.
- DEBUG is disabled for security
- Use environment variables for sensitive data
- Enable SSL/HTTPS security features
- Configure allowed hosts properly

For local development, use settings_local.py instead.
To switch between environments, change DJANGO_SETTINGS_MODULE in manage.py or wsgi.py
"""
